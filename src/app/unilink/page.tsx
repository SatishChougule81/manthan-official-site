...
export const metadata: Metadata = {
  ...
  description:
    "Download UniLink — the universal bridge between your applications and any LLM model. Connect to any cloud API or local model and switch seamlessly.",
};
        ...
        <div className="flex-1 p-4 bg-surface-container/40 overflow-hidden">
          <div className="mb-4">
            ...
            <p className="text-[10px] text-on-surface-variant/50 mt-0.5">
              Manage your AI connection and models
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 mb-4">
            {[
              { label: "Provider", value: "1", sub: "Active" },
          ...
          <div className="border border-outline-variant/15 rounded-lg p-3">
            ...
            <div className="flex items-center gap-2 overflow-x-auto">
              ...
              <div className="space-y-1.5 shrink-0">
                {[
                  { name: "Llama 3 8B", color: "bg-green-400", active: true },
                  { name: "OpenAI GPT-4o", color: "bg-outline-variant/30", active: false },
                  { name: "Claude 3.5", color: "bg-outline-variant/30", active: false },
                  { name: "Local GGUF", color: "bg-outline-variant/30", active: false },
                ].map((m) => (
                  <div key={m.name} className={`flex items-center gap-1.5 ${m.active ? "" : "opacity-40"}`}>
                    <div
...
const FEATURES = [
  {
    ...
    description:
      "Switch between any cloud or local model without changing a single line of code. One connection at a time, any provider you need.",
  },
  {
    icon: "monitoring",
  ...
  },
  {
    ...
    description:
      "Run GGUF, Ollama, and other local models as an alternative to cloud providers. Your data stays on your machine.",
  },
  {
    icon: "play_circle",
    title: "Built-in Playground",
    description:
      "Test prompts, fine-tune parameters, and iterate on your connected model — all without writing code.",
  },
  {
    icon: "lock",
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <Entrance delay={0.1}>
              <p className="text-on-surface-variant/60 text-lg text-center max-w-2xl mx-auto mb-16">
                ...
                integrated model switching and management.
              </p>
            </Entrance>
