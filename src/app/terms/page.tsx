          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-8 text-on-surface-variant/70 text-sm leading-relaxed">
              ...
              <div>
                ...
                <p>For questions about these terms, contact us at <a href="mailto:founders@manthanai.co.in" className="text-primary hover:underline">founders@manthanai.co.in</a>.</p>
              </div>
            </div>
          </div>
        </section>
