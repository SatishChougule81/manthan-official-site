  ...
  return (
    <>
      ...
      <main className="pt-20">
                      ...
                      <div className="-rotate-2">
                        <div className="glass-card rounded-xl p-4 border-secondary/20 shadow-xl w-[160px]">
                          <div className="flex items-center gap-2 mb-2">
                            <img src="/logo.png" alt="UniLink" className="w-4 h-4 object-contain" />
                            <span className="text-xs font-semibold text-on-background">UniLink</span>
                          </div>
                          <div className="text-[10px] text-on-surface-variant/50">1 model connected</div>
        ...
        {/* ── Products ── */}
        <section id="products" className="py-24 px-margin-mobile md:px-margin-desktop bg-surface-container-lowest/30 relative overflow-hidden">
                  ...
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-10 h-10 rounded-xl bg-primary/15 flex items-center justify-center">
                        <img src="/logo.png" alt="UniLink" className="w-7 h-7 object-contain" />
                      </div>
                      <div>
                    ...
                    <p className="text-on-surface-variant/70 mb-6 max-w-xl">
                      Connect to any LLM — OpenAI, Anthropic, Mistral, or local GGUF — through a single unified API. Switch between models without changing a line of code.
                    </p>
                    <div className="flex flex-wrap gap-3 mb-6">
                      {["Easy model switching", "Local GGUF support", "Auto API backend", "Works offline"].map((f) => (
                    ...
                    <a href="/unilink" className="inline-flex items-center gap-2 bg-primary text-on-primary font-bold px-6 py-3 rounded-full text-sm hover:brightness-110 transition-all">
                  ...
                  <div className="hidden lg:block w-[280px] shrink-0">
                    <div className="glass-card rounded-xl p-4 border-primary/10">
                      <div className="space-y-2">
                        {[
                          { model: "GPT-4o", provider: "OpenAI", dot: "bg-green-400", active: true },
                          { model: "Claude 3.5", provider: "Anthropic", dot: "bg-outline-variant/30", active: false },
                          { model: "Llama 3 8B", provider: "Local", dot: "bg-outline-variant/30", active: false },
                        ].map((m) => (
                          <div key={m.model} className={`flex items-center justify-between py-2 px-3 rounded-lg border text-xs ${m.active ? "bg-primary/5 border-primary/15" : "bg-surface-container-lowest/30 border-outline-variant/8 opacity-50"}`}>
                            <div>
        ...
        {/* ── Impact / Case Studies ── */}
        <section className="py-24 px-margin-mobile md:px-margin-desktop bg-surface-container-lowest/30 relative overflow-hidden">
        ...
        <section className="relative py-24 overflow-hidden">
          ...
          <div className="max-w-[1440px] mx-auto px-margin-mobile md:px-margin-desktop">
            <Reveal>
              <div className="text-center mb-16">
                <h2 className="font-display-lg text-4xl md:text-5xl mb-4">What our clients say</h2>
              </div>
            </Reveal>
        ...
        {/* ── CTA / Contact ── */}
        <section id="contact" className="relative py-24 px-margin-mobile md:px-margin-desktop text-center overflow-hidden">
            ...
            <Reveal delay={0.2}>
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <MagneticButton strength={0.2}>
                  <a href="mailto:founders@manthanai.co.in" className="inline-flex items-center gap-2 bg-primary text-on-primary font-bold px-10 py-4 rounded-full text-lg animate-glow-pulse hover:scale-105 active:scale-95 transition-transform duration-300">
