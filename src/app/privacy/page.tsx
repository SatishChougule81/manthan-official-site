          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose-custom space-y-8 text-on-surface-variant/70 text-sm leading-relaxed">
              ...
              <div>
                ...
                <p>You have the right to: access your personal data, request correction or deletion, opt out of marketing communications, and request a copy of your data. Contact us at founders@manthanai.co.in for any requests.</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p>For privacy-related questions, contact us at <a href="mailto:founders@manthanai.co.in" className="text-primary hover:underline">founders@manthanai.co.in</a>.</p>
              </div>
            </div>
          </div>
        </section>
