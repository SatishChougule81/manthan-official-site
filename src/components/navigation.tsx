...
const navigation: NavLink[] = [
  {
    ...
    dropdown: {
      ...
      columns: 2,
      items: [
        { name: "UniLink", description: "Universal AI Connectivity Platform", icon: "hub", href: "/unilink", logoSrc: "/logo.png" },
                  ...
                  {activeNav.dropdown.items.map((sub, i) => (
                    ...
                    >
                      <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center text-primary shrink-0 group-hover:bg-primary/20 transition-colors">
                        {sub.logoSrc ? (
                          <img src={sub.logoSrc} alt={sub.name} className="w-6 h-6 object-contain" />
                        ) : sub.svgPath ? (
                          ...
                          >
                            <div className="pb-3 space-y-0.5">
                              {item.dropdown.items.map((sub) => (
                                ...
                                >
                                  {sub.logoSrc ? (
                                    <img src={sub.logoSrc} alt={sub.name} className="w-5 h-5 object-contain shrink-0" />
                                  ) : sub.svgPath ? (
